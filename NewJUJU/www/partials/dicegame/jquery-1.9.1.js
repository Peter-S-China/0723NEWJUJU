...
var myApp = angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives','ajoslin.mobile-navigate','ngMobile'])
    ...
    $routeProvider.when('/view1', {
                    templateUrl: 'partials/notificationView.html',controller: RaceCntl});
             
    $routeProvider.when('/view11', {templateUrl: 'partials/homewin.html'});
    $routeProvider.when('/view12', {templateUrl: 'partials/hometie.html'});
    $routeProvider.when('/view13', {templateUrl: 'partials/homelost.html'});
